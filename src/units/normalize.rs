...
pub fn legacy_unit_with_customary_system(
    ...
    Some(match alias {
        ...
        "m2" | "m²" => ordinary("m^2", "m²", "Area", "🏠"),
        "cm2" | "cm²" => ordinary("cm^2", "cm²", "Area", "🏠"),
        "in2" | "in²" => ordinary("in^2", "in²", "Area", "🏠"),
        "ft2" | "ft²" => ordinary("ft^2", "ft²", "Area", "🏠"),
        "mi2" | "mi²" => ordinary("mi^2", "mi²", "Area", "🏠"),
        "yd2" | "yd²" => ordinary("yd^2", "yd²", "Area", "🏠"),
        "mm2" | "mm²" => ordinary("mm^2", "mm²", "Area", "🏠"),
        "km2" | "km²" => ordinary("km^2", "km²", "Area", "🏠"),
        ...
        "kwh" | "kWh" => ordinary("kWh", "kWh", "Energy", "☀️"),
        ...
        "km/l" | "km/L" => fuel("km/L", FuelUnit::KilometersPerLiter),
        "l/100km" | "L/100km" => fuel("L/100km", FuelUnit::LitersPer100Kilometers),
        ...
        "kpa" | "kPa" => ordinary("kPa", "kPa", "Pressure", "🧯"),
        "hpa" | "hPa" => ordinary("hPa", "hPa", "Pressure", "🧯"),
        "inhg" | "inHg" => ordinary("legacy_inch_of_mercury", "inHg", "Pressure", "🧯"),
        ...
        "cm3" | "cm³" => ordinary("cm^3", "cm³", "Volume", "🧪"),
        "ft3" | "ft³" => ordinary("ft^3", "ft³", "Volume", "🧪"),
        "in3" | "in³" => ordinary("in^3", "in³", "Volume", "🧪"),
        "mm3" | "mm³" => ordinary("mm^3", "mm³", "Volume", "🧪"),
        ...
        "fl" | "fL" => ordinary("femtoliter", "fL", "Volume", "🧪"),
        "pl" | "pL" => ordinary("picoliter", "pL", "Volume", "🧪"),
        "nl" | "nL" => ordinary("nanoliter", "nL", "Volume", "🧪"),
        "µl" | "µL" => ordinary("microliter", "µL", "Volume", "🧪"),
        "dl" | "dL" => ordinary("deciliter", "dL", "Volume", "🧪"),
        "cl" | "cL" => ordinary("centiliter", "cL", "Volume", "🧪"),
