...
- [CHORE] update [alfred_workflow](https://pub.dev/packages/alfred_workflow) to 1.2.0 (was 1.1.3)
- [CHORE] update [analyzer](https://pub.dev/packages/analyzer) to 8.4.1 (was 7.3.0) (9.0.0 available)
- [CHORE] update [build](https://pub.dev/packages/build) to 4.0.2 (was 2.4.2)
- [CHORE] update [build_config](https://pub.dev/packages/build_config) to 1.2.0 (was 1.1.2)
- [CHORE] update [build_daemon](https://pub.dev/packages/build_daemon) to 4.1.0 (was 4.0.4)
- [CHORE] update [build_runner](https://pub.dev/packages/build_runner) to 2.10.1 (was 2.4.15)
- [CHORE] update [built_value](https://pub.dev/packages/built_value) to 8.12.0 (was 8.9.5)
- [CHORE] update [checked_yaml](https://pub.dev/packages/checked_yaml) to 2.0.4 (was 2.0.3)
- [CHORE] update [code_builder](https://pub.dev/packages/code_builder) to 4.11.0 (was 4.10.1)
- [CHORE] update [copy_with_extension](https://pub.dev/packages/copy_with_extension) to 10.0.1 (was 6.0.1)
- [CHORE] update [dart_style](https://pub.dev/packages/dart_style) to 3.1.2 (was 3.0.1)
- [CHORE] update [decimal](https://pub.dev/packages/decimal) to 3.2.4 (was 3.2.1)
- [CHORE] update [envied](https://pub.dev/packages/envied) to 1.3.1 (was 1.1.1)
- [CHORE] update [envied_generator](https://pub.dev/packages/envied_generator) to 1.3.1 (was 1.1.1)
- [CHORE] update [http](https://pub.dev/packages/http) to 1.5.0 (was 1.3.0)
- [CHORE] update [json_serializable](https://pub.dev/packages/json_serializable) to 6.11.1 (was 6.9.4)
- [CHORE] update [lints](https://pub.dev/packages/lints) to 6.0.0 (was 5.1.1)
- [CHORE] update [meta](https://pub.dev/packages/meta) to 1.17.0 (was 1.16.0)
- [CHORE] update [petitparser](https://pub.dev/packages/petitparser) to 7.0.1 (was 6.1.0)
- [CHORE] update [plist_parser](https://pub.dev/packages/plist_parser) to 0.2.5 (was 0.0.11)
- [CHORE] update [pool](https://pub.dev/packages/pool) to 1.5.2 (was 1.5.1)
- [CHORE] update [source_gen](https://pub.dev/packages/source_gen) to 4.0.2 (was 2.0.0)
- [CHORE] update [source_helper](https://pub.dev/packages/source_helper) to 1.3.8 (was 1.3.5)
- [CHORE] update [test_api](https://pub.dev/packages/test_api) to 0.7.7 (was 0.7.4)
- [CHORE] update [timezone](https://pub.dev/packages/timezone) to 0.10.1 (was 0.10.0)
- [CHORE] update [units_converter](https://pub.dev/packages/units_converter) to 3.0.4 (was 3.0.2)
- [CHORE] update [watcher](https://pub.dev/packages/watcher) to 1.1.4 (was 1.1.1)
- [CHORE] update [web_socket](https://pub.dev/packages/web_socket) to 1.0.1 (was 0.1.6)
- [CHORE] update [web_socket_channel](https://pub.dev/packages/web_socket_channel) to 3.0.3 (was 3.0.2)
- [CHORE] update [xml](https://pub.dev/packages/xml) to 6.6.1 (was 6.5.0)
